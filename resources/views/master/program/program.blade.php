                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        {{-- hidden--}}
                                        <input type="hidden" class="form-control mp_id" name="mp_id">

                                        <div class="form-group">
                                            <label>Nama:</label>
                                            <input type="text" class="form-control mp_name" name="mp_name"
                                                placeholder="Nama">
                                        </div>

                                        <div class="form-group">
                                            <label>Unit:</label>
                                            <select class="form-control" name="mp_unit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="mp_department">
    ...
    $(document).ready(function () {
        table.DataTable({
            ...
            columns: [
                ...
                {
                    data: 'mp_yearly_budget',
                    name: 'mp_yearly_budget',
                    class: 'name_td',
                },
            ],
            columnDefs: [{
