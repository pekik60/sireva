                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        {{-- hidden--}}
                                        <input type="hidden" class="form-control ms_id" name="mc_id">

                                        <div class="form-group">
                                            <label>Nama:</label>
                                            <input type="text" class="form-control ms_name" name="mc_name"
                                                placeholder="Nama">
                                        </div>

                                        <div class="form-group">
                                            <label>Unit:</label>
                                            <select class="form-control" name="mc_unit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="mc_department">
                                        ...
                                        <div class="form-group">
                                            <label>Program:</label>
                                            <select class="form-control" name="mc_program">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="mc_kegiatan">
                                        ...
                                        <div class="form-group">
                                            <label>Output:</label>
                                            <select class="form-control" name="mc_output">
                                                @foreach ($output as $outputs)
                                            <option value="{{$outputs->mo_id}}">
                                                        {{$outputs->mo_name}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="mc_sub_output">
                                                @foreach ($sub_output as $sub_outputs)
                                            <option value="{{$sub_outputs->ms_id}}">
                                                        {{$sub_outputs->ms_name}}
                                                    </option>
                                                @endforeach
                                            </select>
    ...
    $(document).ready(function () {
        table.DataTable({
            ...
            columns: [
                ...
                {
                    data: 'm_output.mo_name',
                    name: 'mc_output',
                    class: 'name_td',
                },
                {
                    data: 'm_sub_output.ms_name',
                    name: 'mc_sub_output',
                    class: 'name_td',
                },
                {
                ...
                {
                    data: 'mc_yearly_budget',
                    name: 'mc_yearly_budget',
                    class: 'name_td',
                },
            ],
            columnDefs: [{
