                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        {{-- hidden--}}
                                        <input type="hidden" class="form-control ms_id" name="ms_id">

                                        <div class="form-group">
                                            <label>Nama:</label>
                                            <input type="text" class="form-control ms_name" name="ms_name"
                                                placeholder="Nama">
                                        </div>

                                        <div class="form-group">
                                            <label>Unit:</label>
                                            <select class="form-control" name="ms_unit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ms_department">
                                        ...
                                        <div class="form-group">
                                            <label>Program:</label>
                                            <select class="form-control" name="ms_program">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ms_kegiatan">
                                        ...
                                        <div class="form-group">
                                            <label>Output:</label>
                                            <select class="form-control" name="ms_output">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table.DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('sub_output_datatable') }}',
                error: function () {
            ...
            columns: [
                ...
                {
                    data: 'ms_yearly_budget',
                    name: 'ms_yearly_budget',
                    class: 'name_td',
                },
            ],
            columnDefs: [{
