<div class="navbar navbar-dark navbar-expand-md fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <span class="badge bg-primary ml-md-3 mr-md-auto " style="padding: 10px;border-radius:unset;font-size: 13px">{{ date('d F Y') }} <span class="digital-clock"></span></span>

            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a href="#" class="navbar-nav-link dropdown-toggle caret-0" onclick="notifications()" data-toggle="dropdown">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item"><i class="icon-user-plus"></i> My profile</a>
